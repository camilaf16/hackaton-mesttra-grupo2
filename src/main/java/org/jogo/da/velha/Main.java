...
public class Main { //classe principal do jogo
    ...
    public static void main(String[] args) throws InterruptedException { //método principal
        ...
        logo();
        //obter caractere do usuario, caractere do computador e sorteio de quem começa jogando
            ...
            try { //Pede valor de entrada
                ...
                valor = Character.toUpperCase(entrada.charAt(0)); //converte o caractere para maiúsculo
                    if(CARACTERES_IDENTIFICADORES_ACEITOS.indexOf(valor) != -1){ //verifica se o caractere é válido
                        valorValido = true;
                    } else { //se caractere for inválido pararece mensagem de erro
    ...
    static int[] obterJogadaUsuario(String posicoesLivres, Scanner teclado) {
        ...
        while (true) {
            ...
            // O usuário informa a jogada no formato "linha coluna" considerando posições de 1 a 3.
            // Exemplo: 1 1 representa o canto superior esquerdo, 3 3 o canto inferior direito,
            ...
            valor[0] = Integer.parseInt(partes[0]) - 1; //linhas
            jogada += valor[0];
            jogada += " ";
            valor[1] = Integer.parseInt(partes[1]) - 1; //colunas
            jogada += valor[1];
